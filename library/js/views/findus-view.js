define([
	...
	'common',
	'lodash',
	'text!templates/findus-panel.html',
	'gsap',

], function($, _c, _, findus_panel_tmpl) {

	/**  ____________________
	 *** Finud View Constructor
	 **/
	var FindUsView = function(find_us_view, ) {
		var that = this,
			_c_s = _c.SELECTORS;

			this.view_panel = find_us_view;
	 ...
	 * @type {Object}
	 */
	FindUsView.prototype.view_panel = null;
	/**
